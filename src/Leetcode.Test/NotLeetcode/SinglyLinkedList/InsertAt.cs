...
namespace Leetcode.Test.NotLeetcode.SinglyLinkedList
{
    public class InsertAt
    {
        ...
        public static IEnumerable<object[]> TestData()
        {
            ...
            testData.Add(new object[] { linkedList1, -1, 0 , -1 });
            ...
            testData.Add(new object[] { linkedList2, 2, 2, 2 });
            ...
            var trd3 = new SinglyLinkedListNode<int>(3);
            var fth3 = new SinglyLinkedListNode<int>(4);
            ...
            testData.Add(new object[] { linkedList3, 5, 5, 5 });
